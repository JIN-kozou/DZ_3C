...
namespace SteamAudio
{
    ...
    public class SteamAudioManagerInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            string[] hrtfOptions = tgt.hrtfNames;
            if (hrtfOptions == null || hrtfOptions.Length == 0)
            {
                EditorGUILayout.HelpBox(
                    "HRTF names are populated at runtime after Steam Audio initializes. Using a default entry in the Inspector.",
                    MessageType.Info);
                hrtfOptions = new[] { "Default" };
            }

            mCurrentHRTF.intValue = EditorGUILayout.Popup("Current HRTF", mCurrentHRTF.intValue, hrtfOptions);

...
namespace DZ_3C.UI.WorldInteraction
{
  ...
  {
    public const string DefaultPromptPrefabPath = "Assets/Prefab/UI/WorldInteractionPrompt.prefab";
    public const string DefaultMarkerPrefabPath = "Assets/Prefab/UI/WorldInteractionMarker.prefab";

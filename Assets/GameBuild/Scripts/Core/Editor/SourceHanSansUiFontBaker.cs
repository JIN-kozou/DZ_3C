...
public static class SourceHanSansUiFontBaker
{
    private const string FontAssetPath =
        "Assets/GameBuild/Art/_Arts/Font/SourceHanSansCN-Normal SDF.asset";

    private const string CharacterListPath =
        "Assets/GameBuild/Art/_Arts/Font/SourceHanSansCN-UICharacters.txt";
    ...
    private static char[] LoadRequiredCharacters()
    {
        ...
        foreach (var guid in AssetDatabase.FindAssets("t:Scene", new[] { "Assets/GameBuild/Scenes" }))
        {

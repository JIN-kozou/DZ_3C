...
namespace DZ_3C.MachineRepair.Editor
{
    ...
    {
        private const string ResourcesDir = "Assets/GameBuild/Resources/Config/MachineRepair";
        private const string PrefabPath = "Assets/GameBuild/Prefabs/MachineRepair/MachineRepair_DemoRoot.prefab";
        private const string TriangleMeshPath = "Assets/GameBuild/Prefabs/MachineRepair/Meshes/MachinePart_Triangle.asset";
        private const string PrefabTier1 = "Assets/GameBuild/Prefabs/MachineRepair/MachinePart_Tier1.prefab";
        private const string PrefabKey = "Assets/GameBuild/Prefabs/MachineRepair/MachinePart_Key.prefab";
        private const string PrefabTier2 = "Assets/GameBuild/Prefabs/MachineRepair/MachinePart_Tier2.prefab";
        ...
        public static void CreateDefinitionsAndDemoPrefab()
        {
            ...
            if (!AssetDatabase.IsValidFolder("Assets/GameBuild/Prefabs/MachineRepair"))
            {
                if (!AssetDatabase.IsValidFolder("Assets/GameBuild/Prefabs"))
                {
                    AssetDatabase.CreateFolder("Assets", "Prefab");
                }

                AssetDatabase.CreateFolder("Assets/GameBuild/Prefabs", "MachineRepair");
            }
        ...
        {
            if (!AssetDatabase.IsValidFolder("Assets/GameBuild/Resources"))
            {
                AssetDatabase.CreateFolder("Assets", "Resources");
            }

            if (!AssetDatabase.IsValidFolder("Assets/GameBuild/Resources/Config"))
            {
                AssetDatabase.CreateFolder("Assets/GameBuild/Resources", "Config");
            }

            if (!AssetDatabase.IsValidFolder(ResourcesDir))
            {
                AssetDatabase.CreateFolder("Assets/GameBuild/Resources/Config", "MachineRepair");
            }
        }
        ...
        {
            if (!AssetDatabase.IsValidFolder("Assets/GameBuild/Prefabs/MachineRepair/Meshes"))
            {
                AssetDatabase.CreateFolder("Assets/GameBuild/Prefabs/MachineRepair", "Meshes");
            }

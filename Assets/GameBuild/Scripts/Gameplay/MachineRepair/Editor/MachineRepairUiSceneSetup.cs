...
namespace DZ_3C.MachineRepair.Editor
{
    ...
    {
        private const string UiTestScenePath = "Assets/GameBuild/Scenes/UITest.unity";
        private const string LevelTestScenePath = "Assets/GameBuild/Scenes/Level test.unity";
        private const string HudCanvasPrefabPath = "Assets/GameBuild/Prefabs/UI/Canvas.prefab";
        private const string SuccessBannerPath = "Assets/GameBuild/Prefabs/UI/getGearBanner.prefab";
        private const string FailBannerPath = "Assets/GameBuild/Prefabs/UI/failgetGearBanner.prefab";
        ...
        private static void WireScene(string scenePath, string sceneLabel)
        {
            ...
            panelSo.FindProperty("tier1Definition").objectReferenceValue =
                AssetDatabase.LoadAssetAtPath<MachinePartDefinition>(
                    "Assets/GameBuild/Resources/Config/MachineRepair/Tier1Material.asset");

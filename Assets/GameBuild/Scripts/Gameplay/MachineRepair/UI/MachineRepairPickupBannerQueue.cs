...
namespace DZ_3C.MachineRepair.UI
{
    public class MachineRepairPickupBannerQueue : MonoBehaviour
    {
        ...
        private const string SuccessPrefabPath = "Assets/GameBuild/Prefabs/UI/getGearBanner.prefab";
        private const string FailPrefabPath = "Assets/GameBuild/Prefabs/UI/failgetGearBanner.prefab";
